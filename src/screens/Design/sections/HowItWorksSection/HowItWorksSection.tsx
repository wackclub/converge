            ...
            <div className="flex flex-col items-center max-w-5xl mx-auto px-4">
                ...
                <div className="font-['Fraunces',Helvetica] text-[#552200] text-xl sm:text-3xl text-center mb-16">
                    <div className="text-pretty space-y-4">
                        <p><b className="font-extrabold">▪ Built one or more bots for a chat app</b> - ideally on <i>different</i> platforms (but that’s optional).</p>
                        <p><b className="font-extrabold">▪ Made them usable.</b> Other people were able to interact with your bots for themselves.</p>
                        <p><b className="font-extrabold">▪ Earned 🪙 1 token per hour</b> of coding (max 10 tokens). You could split the time across multiple bots - but you’ll need to clock <b className="font-extrabold">at least 4 hours total</b> to unlock the <i>Emporium</i>.</p>
                        <p><b className="font-extrabold">▪ Bonus tokens:</b> Used more than one platform? You got <b className="font-extrabold">+1 token per platform</b> used to create your bot(s)</p>
                        <p><b className="font-extrabold">▪ Spent your tokens</b> on rewards in the Emporium.</p>
                    </div>
                </div>
